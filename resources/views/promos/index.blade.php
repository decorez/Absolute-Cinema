        ...
        <tbody class="divide-y divide-white/5">
            @forelse($promos as $promo)
                <tr class="hover:bg-white/5 transition">
                    ...
                    <td class="px-6 py-4">
                        @if($promo->is_active && $promo->end_date >= now()->toDateString())
                            <span class="px-2 py-1 text-[10px] font-bold uppercase bg-green-500/10 text-green-400 rounded-lg border border-green-500/20">Active</span>
                        @else
                            <span class="px-2 py-1 text-[10px] font-bold uppercase bg-red-500/10 text-red-400 rounded-lg border border-red-500/20">Expired</span>
                        @endif
                    </td>
