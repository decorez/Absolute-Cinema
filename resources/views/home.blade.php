...
<div class="min-h-screen text-white bg-gradient-to-br from-[#1B3C53] via-[#234C6A] to-[#456882]">
    ...
    <nav class="sticky top-0 z-50 mx-auto flex items-center justify-between px-10 py-5 backdrop-blur-md bg-[#1B3C53]/60 border-b border-white/10">
        ...
        <div class="flex items-center gap-8">
            ...
            <a href="{{ route('promos.all') }}" class="transition hover:text-[#D2C1B6] text-sm font-medium">Promo</a>
            ...
            @auth
                <div class="relative inline-block text-left" x-data="{ open: false }">
                    <button @click="open = !open" @click.away="open = false" class="flex items-center gap-2.5 bg-white/5 border border-white/10 hover:bg-white/10 px-3 py-1.5 rounded-full transition focus:outline-none">
                        ...
                        <svg class="w-3 h-3 text-[#D2C1B6]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M19 9l-7 7-7-7"></path></svg>
                    </button>
    ...
    <section class="max-w-6xl mx-auto pt-8 pb-10 px-6 flex flex-col items-center">
        ...
        <div class="w-full max-w-2xl relative mb-10">
            ...
            <input type="text" placeholder="Cari film atau bioskop..." class="w-full pl-12 pr-4 py-3 bg-[#1B3C53]/40 border border-white/10 rounded-full text-sm text-white placeholder-white/40 focus:outline-none focus:border-[#D2C1B6] focus:ring-1 focus:ring-[#D2C1B6] backdrop-blur-md shadow-lg transition duration-300" />
        </div>
    ...
    <section id="promo-list" class="max-w-6xl mx-auto pb-16 px-6 scroll-mt-24">
        <div class="mb-6 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                ...
                <div class="flex gap-2">
                    <button class="promo-prev bg-white/5 hover:bg-white/10 border border-white/10 p-2 rounded-full transition focus:outline-none">
                        <svg class="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path></svg>
                    </button>
                    <button class="promo-next bg-white/5 hover:bg-white/10 border border-white/10 p-2 rounded-full transition focus:outline-none">
        ...
        <div class="swiper promo-swiper overflow-hidden rounded-2xl">
            <div class="swiper-wrapper">
                <div class="swiper-slide !h-auto overflow-hidden rounded-2xl bg-[#234C6A]/80 border border-white/5 flex flex-col justify-between p-5 hover:border-yellow-400/20 transition duration-300">
                    <div>
                        ...
                        <h3 class="mt-3 text-lg font-bold">Popcorn Combo</h3>
                        <p class="mt-1 text-xs text-[#D2C1B6] leading-relaxed">
                            Large popcorn + 2 drinks special price today.
                        </p>
                    </div>
                    <button class="mt-4 w-max rounded-xl bg-white/10 border border-white/10 px-4 py-1.5 text-xs font-semibold text-white hover:bg-white/20 transition">
                        Claim Promo
                    </button>
                </div>

                <div class="swiper-slide !h-auto overflow-hidden rounded-2xl bg-[#234C6A]/80 border border-white/5 flex flex-col justify-between p-5 hover:border-red-400/20 transition duration-300">
                    <div>
                        ...
                        <h3 class="mt-3 text-lg font-bold">Buy 1 Get 1</h3>
                        <p class="mt-1 text-xs text-[#D2C1B6] leading-relaxed">
                ...
                <div class="swiper-slide !h-auto overflow-hidden rounded-2xl bg-[#234C6A]/80 border border-white/5 flex flex-col justify-between p-5 hover:border-cyan-400/20 transition duration-300">
                    <div>
                        ...
                        <h3 class="mt-3 text-lg font-bold">Member Cashback</h3>
                        <p class="mt-1 text-xs text-[#D2C1B6] leading-relaxed">
